    ...
    <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1fr_320px]">
      <div className="space-y-6">
        ...
        <section className="animate-fade-up anim-d3">
          ...
          <div className="grid grid-cols-3 gap-2.5 sm:grid-cols-4 md:grid-cols-6 grid-spacing">
...
function QuickLink({
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col items-center gap-2 rounded-2xl border border-primary/30 bg-card px-3 py-3.5 text-xs transition hover:-translate-y-1 hover:border-primary hover:shadow-pop hover:bg-primary/5"
    >
