  ...
  const schemes: Record<ThemeScheme, { light: Record<string, string>; dark: Record<string, string> }> = {
    violet: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 285)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 285)",
    ...
    blue: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 240)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 240)",
    ...
    emerald: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 150)",
    ...
    amber: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 85)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 85)",
    ...
    rose: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 350)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 350)",
    ...
    indigo: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 260)",
    ...
    orange: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 50)",
    ...
    cyan: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 195)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 195)",
    ...
    fuchsia: {
      light: {
        ...
        "--muted-foreground": "oklch(0.505 0.02 315)",
      ...
      dark: {
        ...
        "--muted-foreground": "oklch(0.68 0.018 315)",
