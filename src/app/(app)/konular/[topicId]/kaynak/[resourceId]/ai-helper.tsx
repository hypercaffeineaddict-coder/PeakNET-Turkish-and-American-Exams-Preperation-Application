            ...
            <div className="border-t border-border p-3">
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="inline-flex h-9 items-center gap-1 rounded-md bg-primary px-3 text-sm font-medium text-primary-foreground transition hover:opacity-90 disabled:opacity-50"
                >
                  <Send size={14} />
                </button>
              </div>
